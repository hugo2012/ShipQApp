		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ShipQ",
									"targetURL": "comboschscmshipq-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comboschscmshipq-display": {
								"semanticObject": "comboschscmshipq-display",
								"action": "display",
								"description": "Ship Q",
								"title": "ShipQ",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bosch.sd.shipq",
									"url": sap.ui.require.toUrl("com/bosch/sd/shipq")
								}							}
						}
					}
				}
